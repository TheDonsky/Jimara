	...
	namespace Physics {
		namespace {
			...
			private:
				...
				const Reference<TriMesh> m_capsule = TriMesh::Capsule(Vector3(0.0f), 0.15f, 0.7f, 16, 8, 4);
			...
			public:
				inline virtual void PostPhysicsSynch()override {
					...
					Object::Instantiate<CapsuleCollider>(rigidBody, "Capsule collider", 0.15f, 0.7f)->SetAlignment(CapsuleShape::Alignment::Y);
