...
namespace Jimara {
	namespace Graphics {
		...
		public:
			...
			virtual inline Reference<const ConstantBufferBinding> FindConstantBufferBinding(const std::string& name, GraphicsDevice* device)const { return nullptr; }

			virtual inline Reference<const StructuredBufferBinding> FindStructuredBufferBinding(const std::string& name, GraphicsDevice* device)const { return nullptr; }
			
			virtual inline Reference<const TextureSamplerBinding> FindTextureSamplerBinding(const std::string& name)const { return nullptr; }
