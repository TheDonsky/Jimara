...
namespace Jimara {
	namespace Graphics {
		...
		public:
			...
			virtual void Draw(CommandBuffer* commandBuffer, size_t indexCount, size_t instanceCount, size_t firstIndex = 0u, size_t firstInstance = 0u) = 0;
			...
			virtual void DrawIndirect(CommandBuffer* commandBuffer, IndirectDrawBuffer* indirectBuffer, size_t drawCount, size_t firstCommand = 0u) = 0;
		};
