			...
			public:
				...
				inline virtual void GetGeometry(GraphicsObjectDescriptor::GeometryDescriptor& descriptor)const override {
					...
					// Instances:
					{
						...
						descriptor.instances.liveInstanceEntryCount = (descriptor.instances.liveInstanceRangeBuffer == nullptr) ? descriptor.instances.count : 1u;
					}
...
#pragma warning(default: 4250)
	...
	void MeshRenderer::OnTriMeshRendererDirty() {
		...
		if (ActiveInHierarchy() && Mesh() != nullptr && MaterialInstance() != nullptr && MaterialInstance()->Shader() != nullptr) {
