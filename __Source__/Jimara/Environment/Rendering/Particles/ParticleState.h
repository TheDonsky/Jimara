...
namespace Jimara {
	...
	struct JIMARA_API ParticleState {
		/// <summary> Position of an indivisual particle </summary>
		alignas(16) Vector3 position = Vector3(0.0f);			// Bytes [0 - 12)

		/// <summary> YXZ Euler angles for an indivisual particle (for view-facing quads, only Z should be updated) </summary>
