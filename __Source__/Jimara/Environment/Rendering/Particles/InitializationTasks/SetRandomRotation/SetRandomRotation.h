...
namespace Jimara {
	...
	JIMARA_REGISTER_TYPE(Jimara::ParticleInitialization::SetRandomRotation);

	namespace ParticleInitialization {
		/// <summary>
		/// A particle initialization kernel that randomizes particle rotation/euler-angles
		/// </summary>
		class JIMARA_API SetRandomRotation : public virtual ParticleInitializationTask {
		public:
			/// <summary>
			/// Constructor
			/// </summary>
			/// <param name="systemInfo"> Particle system data </param>
			SetRandomRotation(const ParticleSystemInfo* systemInfo);

			/// <summary> Virtual destructor </summary>
			virtual ~SetRandomRotation();
