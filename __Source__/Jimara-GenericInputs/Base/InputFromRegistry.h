...
namespace Jimara {
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<BooleanInputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<BooleanInputFromRegistry> serializer("Jimara/Input/Value/Boolean", "Boolean Value Input");
		report(&serializer);
	}
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<FloatInputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<FloatInputFromRegistry> serializer("Jimara/Input/Value/Float", "Floating point Value Input");
		report(&serializer);
	}
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<IntInputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<IntInputFromRegistry> serializer("Jimara/Input/Value/Integer", "Integer Value Input");
		report(&serializer);
	}
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<Vector2InputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<Vector2InputFromRegistry> serializer("Jimara/Input/Value/Vector2", "Vector2 Value Input");
		report(&serializer);
	}
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<Vector3InputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<Vector3InputFromRegistry> serializer("Jimara/Input/Value/Vector3", "Vector3 Value Input");
		report(&serializer);
	}
	...
	template<> inline void TypeIdDetails::GetTypeAttributesOf<Vector4InputFromRegistry>(const Callback<const Object*>& report) {
		static const ComponentSerializer::Of<Vector4InputFromRegistry> serializer("Jimara/Input/Value/Vector4", "Vector4 Value Input");
		report(&serializer);
	}
}
